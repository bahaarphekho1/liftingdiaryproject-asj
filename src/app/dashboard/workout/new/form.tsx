...
export default function NewWorkoutForm({ initialDate }: { initialDate: Date }) {
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="space-y-2">
          ...
          <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger className={buttonVariants({ variant: "outline" }) + " w-full justify-start text-left font-normal"}>
